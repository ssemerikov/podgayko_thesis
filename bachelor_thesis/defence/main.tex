...
\item \textbf{Попереднє експертне оцінювання} ($n\geq 3$): SUS + 8~домен-пунктів + 6~сценаріїв (45--60~хв на~експерта)
\item \textbf{Якісно найсильніше:} карта релокації; кольорова семантика статусів; KPI-панель
\item \textbf{Якісно найслабше:} ергономіка форми~6.2; зрозумілість крос-валідації~-- увійшли в~план виправлень
\item \textbf{Повне оцінювання} з~$n\geq 10$ експертів~-- Q2--Q3~2027~р.
\end{itemize}
\end{frame}
...
\item Попереднє експертне оцінювання за~SUS + 8~домен-пунктів; \textbf{TRL~4--5}; дорожня карта Q2~2026 -- Q2--Q3~2027
\end{itemize}
\end{frame}
