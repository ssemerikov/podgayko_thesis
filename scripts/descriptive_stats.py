...
def plot_pub_years(df: pd.DataFrame) -> None:
    ...
    plt.tight_layout()
    plt.savefig(MEDIA_DIR / "fig_pub_years.png", bbox_inches="tight")
    plt.close()
...
def plot_doc_types(df: pd.DataFrame) -> None:
    ...
    plt.tight_layout()
    plt.savefig(MEDIA_DIR / "fig_doc_types.png", bbox_inches="tight")
    plt.close()
...
def plot_top_sources(df: pd.DataFrame, top_n: int = 15) -> None:
    ...
    plt.tight_layout()
    plt.savefig(MEDIA_DIR / "fig_top_sources.png", bbox_inches="tight")
    plt.close()
...
def plot_top_authors(df: pd.DataFrame, top_n: int = 20) -> None:
    ...
    plt.tight_layout()
    plt.savefig(MEDIA_DIR / "fig_top_authors.png", bbox_inches="tight")
    plt.close()
...
def plot_top_countries(df: pd.DataFrame, top_n: int = 20) -> None:
    ...
    plt.tight_layout()
    plt.savefig(MEDIA_DIR / "fig_top_countries.png", bbox_inches="tight")
    plt.close()
...
def plot_keywords_de(df: pd.DataFrame, top_n: int = 30) -> None:
    ...
    plt.tight_layout()
    plt.savefig(MEDIA_DIR / "fig_keywords_de.png", bbox_inches="tight")
    plt.close()
...
def plot_keywords_id(df: pd.DataFrame, top_n: int = 30) -> None:
    ...
    plt.tight_layout()
    plt.savefig(MEDIA_DIR / "fig_keywords_id.png", bbox_inches="tight")
    plt.close()
