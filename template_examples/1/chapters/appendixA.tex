...
%\addcontentsline{toc}{section}{А.\,Детальний аналіз тематичних кластерів досліджень з навчання інформаційній безпеці}

\appendix {\section{\centering Детальний аналіз тематичних кластерів досліджень з навчання інформаційній безпеці}}

{
\setlist[itemize]{nosep, leftmargin=*, label=\textbullet}
\setlength \tabcolsep {0.4\tabcolsep}
\footnotesize
\begin{longtable}{|c|p{2.6cm}|p{3cm}|p{3.1cm}|p{3cm}|p{3cm}|}
\caption{\normalsize Характеристика тематичних кластерів за результатами аналізу VOSviewer.}
\label{VOSviewer}
\\

\hline
\rowcolor{gray!20}
\textbf{№} & \textbf{\makecell{Назва\\ кластера}} & \textbf{\makecell{Ключові\\ терміни}} & \textbf{Характеристики} & \textbf{\makecell{Новітні\\ тренди}} & \textbf{\makecell{Наукові \\імплікації}} \\
\hline
\endfirsthead
...
\end{itemize} & 
\begin{itemize}
    \item Студенто\-центрований підхід
